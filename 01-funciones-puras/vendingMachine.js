 ...
 * @example const totalBalance = credit(50).add(10).add(20) // {balance:80, add:function}
 ...
 * @example checkCredit({name:"Cheetos",price:2.50, position:["A",1]}).gte(2) // false
 ...
 * el dinero
 *
 * En cualquier otro caso la máquina debería devolver un mensaje de error
